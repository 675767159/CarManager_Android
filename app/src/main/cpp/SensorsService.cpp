...
/*
double SensorsService::val1 = 0.5;//系数，0-3,在calculateFuel中使用0-3
double SensorsService::val2 = 0.5;//系数3-10
double SensorsService::val3 = 1.05;//系数10-40
double SensorsService::val4 = 1.1;//系数40-70
double SensorsService::val5 = 1.2;//系数70
double SensorsService::val6 = 1;
double SensorsService::val7 = 1;
double SensorsService::val8 = 1;
double SensorsService::val9 = 1;
double SensorsService::val10 = 1;
*/
//2014-05-29修改
...
double SensorsService::val10 = 1.2;//系数90以上

double SensorsService::maxLiter = 39.99;//油耗上限
double SensorsService::overSpeed = 0;//超速预警时速
int SensorsService::isOverSpeedVal = 0;
...
void SensorsService::calculateFuel(){
	...
	if(vehicleSpeed > 0 || engineRpm > 0) {
		...
		if(vehicleSpeed > 0 && vehicleSpeed <= 3) {
			usaLiter = usaLiter * 0.1;
		}
		if(vehicleSpeed > 3 && vehicleSpeed <= 10) {
			usaLiter = usaLiter * 0.2;
		}
		if(vehicleSpeed >= 20 && vehicleSpeed <= 40) {
		...
		*/
		...
		if(vehicleSpeed > 0 && vehicleSpeed <= 3) {
			usaLiter = usaLiter * val1;
		}
		if(vehicleSpeed > 3 && vehicleSpeed <= 10) {
			usaLiter = usaLiter * val2;
		}
		if(vehicleSpeed >= 10 && vehicleSpeed <= 40) {
			usaLiter = usaLiter * val3;
		}
		if(vehicleSpeed > 40 && vehicleSpeed <= 70) {
			usaLiter = usaLiter * val4;
		}
		if(vehicleSpeed > 70) {
			usaLiter = usaLiter * val5;
		}
		*/
		
		if(vehicleSpeed > 0 && vehicleSpeed <= 10) {
			usaLiter = usaLiter * val1;
		}else if(vehicleSpeed > 10 && vehicleSpeed <= 20) {
			usaLiter = usaLiter * val2;
		}else if(vehicleSpeed > 20 && vehicleSpeed <= 30) {
			usaLiter = usaLiter * val3;
		}else if(vehicleSpeed > 30 && vehicleSpeed <= 40) {
			usaLiter = usaLiter * val4;
		}else if(vehicleSpeed > 40 && vehicleSpeed <= 50) {
			usaLiter = usaLiter * val5;
		}else if(vehicleSpeed > 50 && vehicleSpeed <= 60) {
			usaLiter = usaLiter * val6;
		}else if(vehicleSpeed > 60 && vehicleSpeed <= 70) {
			usaLiter = usaLiter * val7;
		}else if(vehicleSpeed > 70 && vehicleSpeed <= 80) {
			usaLiter = usaLiter * val8;
		}else if(vehicleSpeed > 80 && vehicleSpeed <= 90) {
			usaLiter = usaLiter * val9;
		}else if(vehicleSpeed > 90) {
			usaLiter = usaLiter * val10;
		}
		
		

		//12.31 新加油耗最高39.99
		if(maxLiter>0&&usaLiter>maxLiter)
		{
			usaLiter=maxLiter;						
		}
		...
		/*
		if(vehicleSpeed > 0 && vehicleSpeed <= 3) {
			usaLiter2 = usaLiter2* val1;
		}
		if(vehicleSpeed > 3 && vehicleSpeed <= 10) {
			usaLiter2 = usaLiter2* val2;
		}
		if(vehicleSpeed > 10 && vehicleSpeed <= 40) {
			usaLiter2 = usaLiter2* val3;
		}
		if(vehicleSpeed > 40 && vehicleSpeed <= 70) {
			usaLiter2 = usaLiter2* val4;
		}
		if(vehicleSpeed > 70 ) {
			usaLiter2 = usaLiter2* val5;
		}
		*/
		...
		if(vehicleSpeed > 0 && vehicleSpeed <= 10) {
			...
			usaLiter2 = usaLiter2 * val6;
		}else if(vehicleSpeed > 60 && vehicleSpeed <= 70) {
			usaLiter2 = usaLiter2 * val7;
		}else if(vehicleSpeed > 70 && vehicleSpeed <= 80) {
			usaLiter2 = usaLiter2 * val8;
		}else if(vehicleSpeed > 80 && vehicleSpeed <= 90) {
			usaLiter2 = usaLiter2 * val9;
		}else if(vehicleSpeed > 90) {
			usaLiter2 = usaLiter2 * val10;
		}


		//12.31 新加油耗最高39.99
		if(maxLiter>0&&usaLiter2>maxLiter)
		{
			usaLiter2=maxLiter;
		}
...
void SensorsService::SensorsDataHandler(string sensorsData,string pid )
{
	...
	if(sensorsData.find("4104")!= string::npos&&pid.find("0104")!=string::npos){
		...
		if(arr.size()>0)
		{
			...
			if(vehicleSpeed>50)
				vehicleSpeed = vehicleSpeed*1.02;//时速获取的比真实时速偏低，时速>50时加权2%
	...
	else if(sensorsData.find("4902")!= string::npos&&pid.find("0902")!=string::npos){
...
void SensorsService::initCoefficient(double val1,double val2,double val3,double val4,double val5,double val6,double val7,double val8,double val9,double val10){
	SensorsService::val1 = val1;
	SensorsService::val2 = val2;
	SensorsService::val3 = val3;
	SensorsService::val4 = val4;
	SensorsService::val5 = val5;
	SensorsService::val6 = val6;
	SensorsService::val7 = val7;
	SensorsService::val8 = val8;
	SensorsService::val9 = val9;
	SensorsService::val10 = val10;
}

void SensorsService::setMaxLiter(double val){
	SensorsService::maxLiter = val;
}

void SensorsService::setOverSpeed(double overspeed){
	SensorsService::overSpeed = overspeed;
}

int SensorsService::isOverSpeed(){
	if(SensorsService::overSpeed>0){
		if(SensorsService::vehicleSpeed>SensorsService::overSpeed){
			SensorsService::isOverSpeedVal =1;
		}else{
			SensorsService::isOverSpeedVal =0;
		}
	}else{
		SensorsService::isOverSpeedVal =0;
	}
	return SensorsService::isOverSpeedVal;
}