...
public class TravelSummaryModel {
    ...
    public TravelSummaryModel(Long uid, String userName, String vinCode, String summryData,
            UploadStatusEnum uploadFlag, String StartDate, long onlyFlag, int accelerCount,
            int decelerCount, double mileage, int driveTime, double averageSpeed,
            double averageOilConsume, String carNumber, String EndDate, int carCheckUpScore) {
        this.uid = uid;
    ...
    public String toString() {
        return "TravelSummaryModel{" +
                ...
                ", StartDate='" + StartDate + '\'' +
                ", onlyFlag=" + onlyFlag +
                ", accelerCount=" + accelerCount +
                ", decelerCount=" + decelerCount +
                ", mileage=" + mileage +
                ", driveTime=" + driveTime +
                ", averageSpeed=" + averageSpeed +
                ", averageOilConsume=" + averageOilConsume +
                ", carNumber='" + carNumber + '\'' +
                ", EndDate='" + EndDate + '\'' +
                ", carCheckUpScore=" + carCheckUpScore +
                '}';
    }
}
